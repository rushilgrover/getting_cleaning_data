...
setwd('/Users/rushil/Getting_and_Cleaning_Data/UCI HAR Dataset/');
...
# Assign column names to the test data imported for test data
colnames(subjectTest) = "subjectId";
colnames(xTest)       = features[,2]; 
colnames(yTest)       = "activityId";

# Assigin column names to the data imported for training data
